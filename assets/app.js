...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = ["01-before-pixels.html", "02-research-that-changes-it.html", "03-structure-and-flow.html", "04-the-visual-system.html", "05-interaction-and-copy.html", "06-critique-and-handoff.html"];
...
(function () {
  "use strict";
  var PASSPORT_KEY = "lwp-passport:product-design";
  ...
  if (strip) {
    ...
    var note = el("p", "pp-note", ppCount(got2) === 0
      ...
      : ppCount(got2) >= TOTAL_SESSIONS
        ? "Six of six. You finished the whole course - every lever on the screen scorer is now yours."
